  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl px-5 md:px-10 py-16 md:py-24">
        <div className="prose-invert space-y-8 text-fg-muted">
          <p className="font-serif text-2xl md:text-3xl text-fg leading-snug">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-12 md:gap-8 border-y border-border py-12">
          <div>
            ...
            <p className="font-serif text-xl text-fg mt-4 leading-relaxed">
        ...
        <div className="mt-16">
          ...
          <ul className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-px bg-border border border-border">
            {APPROVED_APPLICATORS.map(b => (
              <li key={b.slug} className="bg-bg p-6 text-center">
                <p className="font-serif text-2xl text-fg">{b.name}</p>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="mt-16">
          ...
          <p className="font-serif text-2xl text-fg mt-3">{SITE.parentGroup}</p>
