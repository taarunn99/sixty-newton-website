...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 md:bottom-7 md:right-7 z-50 group inline-flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-full bg-gold text-bg shadow-[0_10px_30px_-8px_rgba(180,142,46,0.55)] transition-all duration-500 hover:bg-gold-hover hover:scale-105 active:scale-95 motion-reduce:transition-none data-[mounted=false]:opacity-0 data-[mounted=false]:translate-y-3 data-[mounted=true]:opacity-100 data-[mounted=true]:translate-y-0"
    >
      <span
        aria-hidden
