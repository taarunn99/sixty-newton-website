          ...
          <div className="flex items-center gap-5 md:gap-6">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <a
                ...
                className="grid h-9 w-9 place-items-center rounded-full border border-gold/50 text-fg-muted transition-colors duration-200 hover:border-gold hover:bg-gold hover:text-bg active:bg-gold active:text-bg"
              >
